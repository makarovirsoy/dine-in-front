...
@section('content')
	...
	<div class="ml-20 py-4 flex-grow flex flex-col">
		...
		<a type="button" href="/dishes/create"
		   class="mx-20 mb-10 text-white bg-orange-500 hover:bg-orange-400 focus:ring-4 focus:outline-none focus:ring-orange-600 font-medium rounded-lg text-base px-6 py-4 text-center ">
			Speise Hinzufügen
		</a>

		<div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-20">
			<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
				<thead class="text-xs text-orange-500 uppercase bg-orange-100 ">
				<tr>
				...
				@for ($i = 0; $i < 5; $i++)
					<tr class="border-b odd:bg-white even:bg-gray-50 ">
						<th scope="row" class="px-6 py-4 font-medium text-orange-900 whitespace-nowrap">
							getränke
						</th>
